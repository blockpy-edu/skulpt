var $builtinmodule = function (name) {
    ...
    request.Request = Sk.misceval.buildClass(request, requestClass, "Request", []);
        ...
        $loc.__init__ = new Sk.builtin.func(function (self, xhr) {
            ...
            xhr.getAllResponseHeaders()
                ...
                .forEach(function (line) {
                    ...
                    if (parts.length === 2) {
                        self.headers.mp$ass_subscript(
                            new Sk.builtin.str(parts[0].trim()),
                            new Sk.builtin.str(parts[1].trim())
                        );
                    }
                });
            self.closed = false;
