var $builtinmodule = function (name) {
     ...
     */
    mod.Context = Sk.misceval.buildClass(
        mod,
        function ($gbl, $loc) {
            ...
            $loc.bufferData = new Sk.builtin.func(function (self, target, data, usage) {
                self.gl.bufferData(target, data.v, usage);
            });

            $loc.clearColor = new Sk.builtin.func(function (self, red, green, blue, alpha) {
                self.gl.clearColor(
                    Sk.builtin.asnum$(red),
            ...
            $loc.getAttribLocation = new Sk.builtin.func(function (self, program, name) {
                return self.gl.getAttribLocation(program, name.v);
            });

            $loc.getUniformLocation = new Sk.builtin.func(function (self, program, name) {
                return self.gl.getUniformLocation(program, name.v);
            });

            $loc.shaderSource = new Sk.builtin.func(function (self, shader, src) {
                self.gl.shaderSource(shader, src.v);
            });

            $loc.drawArrays = new Sk.builtin.func(function (self, mode, first, count) {
                self.gl.drawArrays(
                    Sk.builtin.asnum$(mode),
                    Sk.builtin.asnum$(first),
                    Sk.builtin.asnum$(count)
                );
            });

            $loc.vertexAttribPointer = new Sk.builtin.func(function (
                self,
                index,
                size,
                type,
            ...
            $loc.viewport = new Sk.builtin.func(function (self, x, y, width, height) {
                self.gl.viewport(
                    Sk.builtin.asnum$(x),
                    Sk.builtin.asnum$(y),
            ...
            $loc.uniformMatrix4fv = new Sk.builtin.func(function (
                self,
                location,
                transpose,
                values
    ...
    mod.Float32Array = Sk.misceval.buildClass(
        mod,
        function ($gbl, $loc) {
     ...
     * 3 7 11 15
     */
    mod.Matrix4x4 = Sk.misceval.buildClass(
        mod,
        function ($gbl, $loc) {
            $loc.__init__ = new Sk.builtin.func(function (self, data) {
                self.v = new Float32Array(Sk.ffi.remapToJs(data));
            ...
            $loc.identity = new Sk.builtin.func(function (self) {
                var m = self.v;
            ...
            $loc.translate = new Sk.builtin.func(function (self, translation) {
                var m = self.v;
