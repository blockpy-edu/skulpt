var $builtinmodule = function (name) {
    ...
    sys.copyright = new Sk.builtin["str"](
    ...
    sys.__stdout__ = new Sk.builtin.file(
        new Sk.builtin.str("/dev/stdout"),
        new Sk.builtin.str("w")
    );
    ...
    sys.exc_info = new Sk.builtin.func(function () {
        if (Sk.err) {
            ...
            const vals = [Sk.builtin.none.none$, Sk.builtin.none.none$, tb];
            return new Sk.builtin.tuple(vals);
        }
    });

    function prepareStackFrame() {
        // Call -> function pairs
